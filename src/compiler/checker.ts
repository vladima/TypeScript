...
module ts {
    ...
    export function createTypeChecker(program: Program): TypeChecker {
        ...
        function getTypeOfVariableDeclaration(declaration: VariableDeclaration): Type {
            ...
            var type = declaration.flags & NodeFlags.Rest ? createArrayType(anyType) : <Type>anyType;
            checkImplicitAny(type);
            return type;
            ...
            if (!(links.flags & NodeCheckFlags.ContextChecked)) {
                ...
                if (!(links.flags & NodeCheckFlags.ContextChecked)) {
                    ...
                    if (contextualSignature) {
                        ...
                        checkControlFlowOfFunction(node, node.type && getTypeFromTypeNode(node.type) !== voidType, error);
